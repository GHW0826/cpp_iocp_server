...
public:
	...
	static SendBufferRef MakeSendBuffer(Protocol::C_ENTERGAME&pkt) { return _MakeSendBuffer(pkt, PKT_C_ENTERGAME); }
	static SendBufferRef MakeSendBuffer(Protocol::C_MOVE&pkt) { return _MakeSendBuffer(pkt, PKT_C_MOVE); }
